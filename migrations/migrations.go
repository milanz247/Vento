...
//
// A migration is a vento.Migration: an ID (timestamp-prefixed, so lexical
...
//
// This package imports vento and models only - never controllers or routes -
// keeping the one-way dependency graph intact.
package migrations
...
// list to hand-edit.
func register(m vento.Migration) {
...
// vento.RunMigrations / vento.RollbackLastMigration.
func All() []vento.Migration {
	out := make([]vento.Migration, len(registry))
	copy(out, registry)
